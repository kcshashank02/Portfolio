          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              ...
              <div className="text-center">
                <h3 className="font-bold text-lg text-gray-800 dark:text-white">Shashank K C</h3>
            ...
            <div className="md:w-2/3">
              ...
              From a young age, I've been fascinated by how things work, especially in the digital realm. This curiosity led me to web development, where I discovered the power to turn ideas into tangible, interactive experiences.<br/>
             
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
              My journey started with the basics of HTML and CSS, quickly progressing to JavaScript and modern frameworks like React and Next.js. I thrive on the challenge of building complex applications, focusing on clean code, performance, and user experience. I'm proficient in both front-end and back-end development, allowing me to contribute across the full stack. As a lifelong learner, I'm always exploring new technologies and methodologies to enhance my skillset and deliver better solutions.
              </p>
